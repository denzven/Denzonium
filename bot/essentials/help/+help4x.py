...
class Help(commands.Cog):
    ...
    async def help4x(self, ctx, *input):
        """Shows all modules of that bot"""
	
	# !SET THOSE VARIABLES TO MAKE THE COG FUNCTIONAL!
        prefix = "+" # ENTER YOUR PREFIX - loaded from config, as string or how ever you want!
        version = "0.01" # enter version of your code

	    # setting owner name - if you don't wanna be mentioned remove line 49-60 and adjust help text (line 88) 
        owner = "denzoid#9397"	# ENTER YOU DISCORD-ID
        owner_name = "denzoid#9397"	# ENTER YOUR USERNAME#1234
